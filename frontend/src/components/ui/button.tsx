...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-accent disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'gradient-accent text-white shadow hover:opacity-90',
        destructive: 'bg-danger text-white shadow-sm hover:bg-danger/90',
        outline: 'border border-border bg-transparent text-text-primary shadow-sm hover:bg-surface-elevated',
        secondary: 'bg-surface-elevated text-text-primary shadow-sm hover:bg-surface-elevated/80',
