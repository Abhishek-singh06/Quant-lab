"""Long-Term Investing Model Implementation."""
...
class LongTermModel(HorizonModel):
    """Long-Term Investing Model for 6-Month to 5-Year horizons."""

    def __init__(
        self,
        model_id: str = "LONG_TERM_RIDGE_v1.0",
        model_version: str = "LT_v1.0.0",
        target_period: str = "ONE_YEAR",
        target_type: TargetType = TargetType.REGRESSION,
        algorithm: ModelAlgorithm = ModelAlgorithm.RIDGE,
        feature_set_version: str = "LONG_TERM_FEATURE_SET_V1",
        target_set_version: str = "LONG_TERM_TARGET_SET_V1",
